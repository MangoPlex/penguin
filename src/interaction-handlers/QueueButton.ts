...
export class QueueButton extends InteractionHandler {
    ...
    public async run(interaction: ButtonInteraction): Promise<void> {
        ...
        if (interaction.customId === "queue-next-page") await this.queueNextPage(interaction);
        if (interaction.customId === "queue-prev-page") await this.queuePrevPage(interaction);
        if (interaction.customId === "queue-close-page") await this.queueClosePage(interaction);
    }
    ...
    private async updateView(interaction: ButtonInteraction, page: number): Promise<void> {
    ...
    private render(interaction: ButtonInteraction, page: number): MessageEmbed | null {
